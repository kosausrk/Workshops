function main() {
    ...
    */
    ...
    //Arrays & Objects 
    var names = ["Mario", "Luigi", "Peach"]; //Only string names are allowed 
    var ages = [25, 28, 32]; //Only number arrays allowed 
    names.push("Yoshi");
    ages.push(42);
    ages.push(69);
    //Type Inference 
    var fruits = ["apples", "pears", "bananas"]; //ts infers the type of the array is fruits 
    fruits.push("kiwi");
